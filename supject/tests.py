...
class TestSubjectListView(APITestCase):
    def setUp(self):
        ...
        self.subject_title1=SubjectTitle.objects.create(name=self.user1, category=self.category1)
        self.subject_title2=SubjectTitle.objects.create(name=self.user2, category=self.category2)
        self.subject_title3=SubjectTitle.objects.create(name=self.user3, category=self.category3)
        self.subject1 = Subject.objects.create(name=self.user1, type="GLOBAL", subject_title=self.subject_title1)
        self.subject2 = Subject.objects.create(name=self.user2, type="LOCAL", subject_title=self.subject_title2)
        self.subject3 = Subject.objects.create(name=self.user3, type="GLOBAL", subject_title=self.subject_title3)
        self.subject_1 = UserSubject.objects.create(subject=self.subject1, user = self.user1, total_test_ball=10, started=True)
        self.subject_2 = UserSubject.objects.create(subject=self.subject2, user = self.user2, total_test_ball=0, started=True)
        self.subject_3 = UserSubject.objects.create(subject=self.subject3, user = self.user3, total_test_ball=30, started=True)
