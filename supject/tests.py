...
from .models import Category, SubjectTitle, Subject
...
class CategoryListViewTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.subject_title = SubjectTitle.objects.create(name="Test Subject Title", category=self.category)
    ...
    def test_get_categories(self):
        ...
        self.assertEqual(len(response.data[0]['subject_titles']), 1)
